...
def get_random_proxy(filename):
    ...
    chosen_proxy = random.choice(proxies).strip() # strip to remove any trailing newline characters
...
def makeTikTokApi():
    ...
    proxy = 'http://brd-customer-hl_b6481680-zone-datacenter_proxy1_tt:sznl2982fvhs@brd.superproxy.io:22225'
